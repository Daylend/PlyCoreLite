...
E2Helper.Descriptions["posInBounds"] = "Returns 1 if the position is in bounds, 0 otherwise."
E2Helper.Descriptions["getPlayersInEvent"] = "Returns an array of players in the event."
